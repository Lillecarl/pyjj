...
def add_parsers(sub) -> None:
    ...
    p_simplify = sub.add_parser("simplify-parents", help="Simplify parent edges for the specified revision(s)")
    p_simplify.set_defaults(_handler="pyjj_cli.cli.stubs:_stub_simplify")
...
def _stub_simplify(args):
    import sys
    print("Error: simplify-parents is not yet supported", file=sys.stderr)
    return 2
