...
def add_parsers(sub) -> None:
    ...
    p_flist.set_defaults(_handler="pyjj_cli.commands.file:file_list")
    ...
    p_fshow.set_defaults(_handler="pyjj_cli.commands.file:file_show")
    ...
    p_fannot.set_defaults(_handler="pyjj_cli.commands.file:file_annotate")
    ...
    p_fchmod.set_defaults(_handler="pyjj_cli.commands.file:file_chmod")
    ...
    p_ftrack.set_defaults(_handler="pyjj_cli.commands.file:file_track")
    ...
    p_funtrack.set_defaults(_handler="pyjj_cli.commands.file:file_untrack")
    ...
    p_fsearch.set_defaults(_handler="pyjj_cli.commands.file:file_search")
