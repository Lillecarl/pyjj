...
def add_parsers(sub) -> None:
    ...
    p_flist.set_defaults(_handler="pyjj_cli.commands:file_list")
    ...
    p_fshow.set_defaults(_handler="pyjj_cli.commands:file_show")
    ...
    p_fannot.set_defaults(_handler="pyjj_cli.commands:file_annotate")
    ...
    p_fchmod.set_defaults(_handler="pyjj_cli.commands:file_chmod")
    ...
    p_ftrack.set_defaults(_handler="pyjj_cli.commands:file_track")
    ...
    p_funtrack.set_defaults(_handler="pyjj_cli.commands:file_untrack")
    ...
    p_fsearch.set_defaults(_handler="pyjj_cli.commands:file_search")
