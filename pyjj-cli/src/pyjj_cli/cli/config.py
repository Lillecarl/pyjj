...
def add_parsers(sub) -> None:
    ...
    p_cfg_get.set_defaults(_handler="pyjj_cli.commands:config_get")
    ...
    p_cfg_list.set_defaults(_handler="pyjj_cli.commands:config_list")
    ...
    p_cfg_set.set_defaults(_handler="pyjj_cli.commands:config_set")
    ...
    p_cfg_unset.set_defaults(_handler="pyjj_cli.commands:config_unset")
