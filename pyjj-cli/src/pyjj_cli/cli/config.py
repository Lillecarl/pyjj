...
def add_parsers(sub) -> None:
    ...
    p_cfg_get.set_defaults(_handler="pyjj_cli.commands.config:config_get")
    ...
    p_cfg_list.set_defaults(_handler="pyjj_cli.commands.config:config_list")
    ...
    p_cfg_set.set_defaults(_handler="pyjj_cli.commands.config:config_set")
    ...
    p_cfg_unset.set_defaults(_handler="pyjj_cli.commands.config:config_unset")
