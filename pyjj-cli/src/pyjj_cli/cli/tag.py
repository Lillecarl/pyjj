...
def add_parsers(sub) -> None:
    ...
    p_tag_list.set_defaults(_handler="pyjj_cli.commands:tag_list")
    ...
    p_tag_set.set_defaults(_handler="pyjj_cli.commands:tag_set")
    ...
    p_tag_delete.set_defaults(_handler="pyjj_cli.commands:tag_delete")
    ...
    p_tag_track.set_defaults(_handler="pyjj_cli.commands:tag_track")
    ...
    p_tag_untrack.set_defaults(_handler="pyjj_cli.commands:tag_untrack")
