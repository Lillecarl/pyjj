...
def add_parsers(sub) -> None:
    ...
    p_hunk_list.set_defaults(_handler="pyjj_cli.commands:hunk_list")
    ...
    p_hunk_split.set_defaults(_handler="pyjj_cli.commands:hunk_split")
    ...
    p_hunk_commit.set_defaults(_handler="pyjj_cli.commands:hunk_commit")
    ...
    p_hunk_squash.set_defaults(_handler="pyjj_cli.commands:hunk_squash")
    ...
    p_hunk_schema.add_argument("--format", choices=["json", "yaml"], default="json",
                               help="Output format (default: json)")
    p_hunk_schema.set_defaults(_handler="pyjj_cli.commands:hunk_schema")
