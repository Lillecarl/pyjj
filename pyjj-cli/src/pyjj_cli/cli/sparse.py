...
def add_parsers(sub) -> None:
    ...
    p_sparse_list.set_defaults(_handler="pyjj_cli.commands.sparse:sparse_list")
    ...
    p_sparse_set.set_defaults(_handler="pyjj_cli.commands.sparse:sparse_set")
    p_sparse_reset = sparse_sub.add_parser("reset", help="Reset the patterns to include all files")
    p_sparse_reset.set_defaults(_handler="pyjj_cli.commands.sparse:sparse_reset")
    p_sparse_edit = sparse_sub.add_parser("edit", help="Start an editor to update the patterns")
    p_sparse_edit.set_defaults(_handler="pyjj_cli.commands.sparse:sparse_edit")
