...
def add_parsers(sub) -> None:
    ...
    p_undo.set_defaults(_handler="pyjj_cli.commands:undo")
    p_redo = sub.add_parser("redo", help="Redo a previously undone operation")
    p_redo.set_defaults(_handler="pyjj_cli.commands:redo")
    ...
    p_opr.set_defaults(_handler="pyjj_cli.commands:op_restore")
    p_op_log2 = op_sub.add_parser("log", help="Show the operation log")
    p_op_log2.set_defaults(_handler="pyjj_cli.commands:op_log")
    ...
    p_op_show2.set_defaults(_handler="pyjj_cli.commands:op_show")
    ...
    p_op_abandon2.set_defaults(_handler="pyjj_cli.commands:op_abandon")
    ...
    p_op_diff2.set_defaults(_handler="pyjj_cli.commands:op_diff")
    ...
    p_op_integrate2.set_defaults(_handler="pyjj_cli.commands:op_integrate")
    ...
    p_op_revert2.set_defaults(_handler="pyjj_cli.commands:op_revert")
    ...
    p_oplog_log.set_defaults(_handler="pyjj_cli.commands:op_log")
    ...
    p_oplog_show.set_defaults(_handler="pyjj_cli.commands:op_show")
    ...
    p_oplog_abandon.set_defaults(_handler="pyjj_cli.commands:op_abandon")
    ...
    p_oplog_diff.set_defaults(_handler="pyjj_cli.commands:op_diff")
    ...
    p_oplog_restore2.set_defaults(_handler="pyjj_cli.commands:op_restore")
    ...
    p_oplog_integrate.set_defaults(_handler="pyjj_cli.commands:op_integrate")
    ...
    p_oplog_revert.set_defaults(_handler="pyjj_cli.commands:op_revert")
    ...
    p_evolog.set_defaults(_handler="pyjj_cli.commands:evolog")
    ...
    p_next.set_defaults(_handler="pyjj_cli.commands:next_commit")
    ...
    p_prev.set_defaults(_handler="pyjj_cli.commands:prev_commit")

    p_par = sub.add_parser("parallelize", help="Parallelize revisions by making them siblings")
    p_par.set_defaults(_handler="pyjj_cli.commands:parallelize")
    p_inter = sub.add_parser("interdiff", help="Show differences between the diffs of two revisions")
    p_inter.set_defaults(_handler="pyjj_cli.commands:interdiff")
