...
def add_parsers(sub) -> None:
    ...
    p_bmc.set_defaults(_handler="pyjj_cli.commands:bookmark")
    ...
    p_bms.set_defaults(_handler="pyjj_cli.commands:bookmark")
    ...
    p_bmd.set_defaults(_handler="pyjj_cli.commands:bookmark")
    ...
    p_bmf.set_defaults(_handler="pyjj_cli.commands:bookmark")
    ...
    p_bml.set_defaults(_handler="pyjj_cli.commands:bookmark")
    ...
    p_bmm.set_defaults(_handler="pyjj_cli.commands:bookmark")
    ...
    p_bmr.set_defaults(_handler="pyjj_cli.commands:bookmark")
    ...
    p_bmt.set_defaults(_handler="pyjj_cli.commands:bookmark_track")
    ...
    p_bmut.set_defaults(_handler="pyjj_cli.commands:bookmark_untrack")
    ...
    p_bma.set_defaults(_handler="pyjj_cli.commands:bookmark_advance")
