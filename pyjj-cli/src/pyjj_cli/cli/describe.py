...
def add_parsers(sub) -> None:
    ...
    p_desc.set_defaults(_handler="pyjj_cli.commands:describe")
    ...
    p_new.set_defaults(_handler="pyjj_cli.commands:new")
    ...
    p_edit.set_defaults(_handler="pyjj_cli.commands:edit")
    ...
    p_com.set_defaults(_handler="pyjj_cli.commands:commit")
    ...
    p_de.set_defaults(_handler="pyjj_cli.commands:diffedit")
    ...
    p_rslv.set_defaults(_handler="pyjj_cli.commands:resolve")
    ...
    p_sign.set_defaults(_handler="pyjj_cli.commands:sign")
    ...
    p_unsign.set_defaults(_handler="pyjj_cli.commands:unsign")
    ...
    p_meta.set_defaults(_handler="pyjj_cli.commands:metaedit")

    p_version = sub.add_parser("version", help="Show version information")
    p_version.set_defaults(_handler="pyjj_cli.commands:version")

    # root shortcut
    p_root = sub.add_parser("root", help="Show the current workspace root directory (shortcut for `jj workspace root`)")
    p_root.set_defaults(_handler="pyjj_cli.commands:workspace_root")
