...
def add_parsers(sub) -> None:
    ...
    p_ginit.set_defaults(_handler="pyjj_cli.commands.git:git_init")
    ...
    p_gclone.set_defaults(_handler="pyjj_cli.commands.git:git_clone")

    p_gcolocation = git_sub.add_parser("colocation", help="Manage Jujutsu repository colocation with Git")
    p_gcolocation.set_defaults(_handler="pyjj_cli.commands.git:git_colocation")
    ...
    p_gcol_status.set_defaults(_handler="pyjj_cli.commands.git:git_colocation")
    p_gcol_enable = colocation_sub.add_parser("enable", help="Convert into a colocated Jujutsu/Git repository")
    p_gcol_enable.set_defaults(_handler="pyjj_cli.commands.git:git_colocation")
    p_gcol_disable = colocation_sub.add_parser("disable", help="Convert into a non-colocated Jujutsu/Git repository")
    p_gcol_disable.set_defaults(_handler="pyjj_cli.commands.git:git_colocation")
    ...
    p_gpush.set_defaults(_handler="pyjj_cli.commands.git:git_push")
    ...
    p_gr_list.set_defaults(_handler="pyjj_cli.commands.git:git_remote")
    ...
    p_gr_add.set_defaults(_handler="pyjj_cli.commands.git:git_remote")
    p_gr_remove = remote_sub.add_parser("remove", help="Remove a Git remote")
    p_gr_remove.add_argument("name", help="Remote name")
    p_gr_remove.set_defaults(_handler="pyjj_cli.commands.git:git_remote")
    ...
    p_gr_rename.set_defaults(_handler="pyjj_cli.commands.git:git_remote")
    ...
    p_gr_set_url.set_defaults(_handler="pyjj_cli.commands.git:git_remote")

    p_groot = git_sub.add_parser("root", help="Show the underlying Git directory")
    p_groot.set_defaults(_handler="pyjj_cli.commands.git:git_root")
