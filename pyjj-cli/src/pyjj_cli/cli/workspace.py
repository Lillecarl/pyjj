...
def add_parsers(sub) -> None:
    ...
    p_ws_add.set_defaults(_handler="pyjj_cli.commands:workspace_add")
    ...
    p_ws_forget.set_defaults(_handler="pyjj_cli.commands:workspace_forget")
    ...
    p_ws_list.set_defaults(_handler="pyjj_cli.commands:workspace_list")
    ...
    p_ws_rename.set_defaults(_handler="pyjj_cli.commands:workspace_rename")
    p_ws_root = ws_sub.add_parser("root", help="Show the workspace root directory")
    p_ws_root.set_defaults(_handler="pyjj_cli.commands:workspace_root")
    p_ws_update = ws_sub.add_parser("update-stale", help="Update a workspace that has become stale")
    p_ws_update.set_defaults(_handler="pyjj_cli.commands:workspace_update_stale")
