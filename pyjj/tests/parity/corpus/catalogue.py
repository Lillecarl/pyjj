...
CATALOGUE: tuple[Entry, ...] = (
    ...
    E("tag-list-all-remotes", ("tag", "list", "--all-remotes"), fixture="tags",
      claims=("tag list", "--all-remotes", "-a"), colour="bytes"),
    E("tag-list-a", ("tag", "list", "-a"), fixture="tags",
      claims=("tag list", "-a"), colour="bytes"),

    # A conflicted ref is what a fetch makes when the local ref and the
    # remote one moved apart. Both listings render it the same way, and
    # `-c` is the flag that keeps only those.
    E("bookmark-list-conflicted-refs", ("bookmark", "list"),
      fixture="conflicted_refs", normalize=("remote",), colour="bytes"),
    E("bookmark-list-conflicted", ("bookmark", "list", "--conflicted"),
      fixture="conflicted_refs", normalize=("remote",),
      claims=("bookmark list", "--conflicted", "-c"), colour="bytes"),
    E("bookmark-list-c", ("bookmark", "list", "-c"),
      fixture="conflicted_refs", normalize=("remote",),
      claims=("bookmark list", "-c"), colour="bytes"),
    E("bookmark-list-sort", ("bookmark", "list", "--sort", "name-"),
      fixture="conflicted_refs", normalize=("remote",),
      claims=("bookmark list", "--sort"), colour="bytes"),
    E("bookmark-list-revision",
      ("bookmark", "list", "-r", 'description(glob:"base*")'),
      fixture="conflicted_refs", normalize=("remote",),
      claims=("bookmark list", "--revision", "-r"), colour="bytes"),
    E("tag-list-sort", ("tag", "list", "--sort", "name-"),
      fixture="conflicted_refs", normalize=("remote",),
      claims=("tag list", "--sort"), colour="bytes"),
    E("tag-list-revision",
      ("tag", "list", "-r", 'description(glob:"base*")'),
      fixture="conflicted_refs", normalize=("remote",),
      claims=("tag list", "--revision", "-r"), colour="bytes"),
    E("tag-list-conflicted", ("tag", "list", "--conflicted"),
      fixture="conflicted_refs", normalize=("remote",),
      claims=("tag list", "--conflicted", "-c"), colour="bytes"),
    E("tag-list-c", ("tag", "list", "-c"), fixture="conflicted_refs",
      normalize=("remote",), claims=("tag list", "-c"), colour="bytes"),
